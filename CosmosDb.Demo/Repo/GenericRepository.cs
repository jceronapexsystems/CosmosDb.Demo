...
namespace CosmosDb.Demo.Repo
{
    public class GenericRepository<T> : IGenericRepository<T> where T : BaseEntity, new()
    {
        ...
        public GenericRepository(IUnitOfWorkFactory unitOfWorkFactory)
        {
        ...
        public async Task<ItemResponse<T>> Create(T entity)
        {
            ...
            // insert the item
            var response = await _unitOfWork.Context.Container.CreateItemAsync(entity, partitionKey: new PartitionKey(entity.Region), new ItemRequestOptions
            {
